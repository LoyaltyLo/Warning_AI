...
if __name__ == "__main__":
    ...
    parser.add_argument('--seed', type=int, default=32, help='Use model_s<seed>.pth and scaler_s<seed>.pkl')
    ...
    for test_db_path in test_db_paths:
        ...
        with mp.Pool(2) as pool:  # reduced workers to avoid memory exhaustion
            for res in tqdm(pool.imap_unordered(evaluate_single_patient, args_list), total=len(args_list)):
                results.append(res)
